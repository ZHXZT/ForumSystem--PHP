...
$query="select count(*) from xzt_content where module_id in ({$id_son})";
$count_all=num($link,$query);
$query="select count(*) from xzt_content where module_id in ({$id_son}) and time >CURDATE()";
...
<div id="position" class="auto">
    <a href="index.php">首页</a> &gt <?php echo $data_father['module_name']; ?>
</div>
...
<div id="main" class="auto">
    <div id="left">
        ...
        <ul class="postsList">
            <?php
            $query="select xzt_content.title,xzt_content.id,xzt_content.time,xzt_content.times,xzt_content.member_id,xzt_member.name,xzt_member.photo,xzt_son_module.module_name,xzt_son_module.id ssm_id from xzt_content,xzt_member,xzt_son_module where xzt_content.module_id in ({$id_son}) and xzt_content.member_id=xzt_member.id and xzt_content.module_id=xzt_son_module.id {$page['limit']}";
            ...
            <li>
                ...
                <div class="subject">
                    <div class="titleWrap"><a href="list_son.php?id=<?php echo $data_content['ssm_id']?>">[<?php echo $data_content['module_name'] ?>]</a>&nbsp&nbsp<h2><a target="_blank" href="show.php?id=<?php echo $data_content['id']?>"><?php echo $data_content['title'] ?></a></h2></div>
                    <p>
