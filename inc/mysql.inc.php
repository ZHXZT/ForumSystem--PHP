...
//数据库链接
function connect() {
    $link=@mysqli_connect($host=DB_HOST,$user=DB_USER,$password=DB_PASSWORD,$database=DB_DATABASE,$port=DB_PORT);
...
function execute_multi($link,$arr_sqls,&$error) {
    ...
    if(mysqli_multi_query($link,$sqls)){
        ...
        $error='执行失败请检查首条语句！<br />可能的原因：'.mysqli_error($link);
        return false;
    }
}
//获取记录数
